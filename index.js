...
<body data-proxy-ip="{{PROXY_IP}}">
  ...
  <script>
    ...
    /**
     * Updates the display for Proxy Server IP information using data from our GeoIP API.
     * @param {object | null} geo - GeoIP data from our worker.
    ...
    /**
     * Fetches GeoIP information from our worker API (which has fallbacks).
    ...
    async function loadNetworkInfo() {
        ...
        if (clientIp) {
            ...
            // Get GeoIP data for client from our unified API
            ...
            // Get Scamalytics risk score
            const scamalyticsData = await fetchScamalyticsClientInfo(clientIp);
            updateScamalyticsClientDisplay(scamalyticsData); // This will now primarily just set the risk score
